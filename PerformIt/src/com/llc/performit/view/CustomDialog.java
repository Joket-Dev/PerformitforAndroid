...
public class CustomDialog extends Dialog {
	protected static final String TAG = CustomDialog.class.getName();
...
//			((TextView) layout.findViewById(R.id.title)).setText(title);
			...
			Typeface btnFont = Typeface.createFromAsset(context.getAssets(), "marvin.ttf");
			((TextView) layout.findViewById(R.id.message)).setTypeface(btnFont);
			((Button) layout.findViewById(R.id.cancel)).setTypeface(btnFont);
			((Button) layout.findViewById(R.id.ok)).setTypeface(btnFont);
